...
- **RULER 基準測試**：聲稱支援 32K+ 上下文的模型中，僅 50% 在 32K Token 時仍維持令人滿意的效能
...
### 4.5 Interleaved Thinking — 推理軌跡最佳化
...
### 6.1 漸進式揭露（Progressive Disclosure）
